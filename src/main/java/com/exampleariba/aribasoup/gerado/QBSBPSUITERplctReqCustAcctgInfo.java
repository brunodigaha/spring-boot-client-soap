...
public class QBSBPSUITERplctReqCustAcctgInfo extends AttributeContainer implements KvmSerializable
{
    ...
    public Boolean PaymentNoticeCustomerClearedItemsIndicator;
    
    public Boolean PaymentNoticeSalesDepartmentIndicator;
    
    public Boolean PaymentNoticeLegalDepartmentIndicator;
    
    public Boolean PaymentNoticeAccountingIndicator;
    
    public Boolean PaymentNoticeCustomerWithoutClearedItemsIndicator;
    ...
    public QBSCashDiscountTermsCode BillOfExchangeChargesCashDiscountTermsCode;
    ...
    public QBSIdentifier ExportCreditInsuranceInstitutionID;
    
    public QBSAmount InsuredAmount;
    
    public String InsuranceLeadDuration;
    
    public BigDecimal DeductiblePercent;
    
    public QBSIdentifier InsuranceID;
    
    public java.util.Date InsuranceValidityDate;
    
    public QBSIdentifier CollectiveInvoiceVariantID;
    ...
    public String NextPayeeInternalID;
    
    public String ReceiverNextPayeeInternalID;
    
    public java.util.Date LastInterestCalculationRunDate;
    
    public Boolean RecordPaymentHistoryIndicator;
    ...
    public String PreviousCustomerInternalID;
    
    public QBSCode PaymentGroupingCode;
    
    public QBSCode LeaveReasonCode;
    
    public QBSCode DunningNoticeGroupingCode;
    
    public QBSCode LockboxCode;
    
    public QBSCode PaymentMethodSupplementCode;
    
    public String BuyingGroupInternalID;
    
    public String ReceiverBuyingGroupInternalID;
    
    public QBSCode PaymentAdvicesSelectionRuleCode;
    
    public Boolean PaymentAdvicesByEDIIndicator;
    
    public QBSCode ReleaseApprovalGroupCode;
    
    public QBSCode ConversionVersionReasonCode;
    ...
    public QBSCode ValueAdjustmentCode;
    
    public Boolean DeletionBlockedIndicator;
    
    public QBSCode AccountsReceivablePledgingCode;
    
    public ArrayList< QBSBPSUITERplctReqDunInfo> DunningInformation =new ArrayList<QBSBPSUITERplctReqDunInfo >();
    
    public ArrayList< QBSBPSUITERplctReqCustWhldgTx> WithholdingTax =new ArrayList<QBSBPSUITERplctReqCustWhldgTx >();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("PaymentNoticeCustomerClearedItemsIndicator"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.PaymentNoticeCustomerClearedItemsIndicator = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.PaymentNoticeCustomerClearedItemsIndicator = (Boolean)obj;
                }
            }
            return true;
        }
        if (info.name.equals("PaymentNoticeSalesDepartmentIndicator"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.PaymentNoticeSalesDepartmentIndicator = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.PaymentNoticeSalesDepartmentIndicator = (Boolean)obj;
                }
            }
            return true;
        }
        if (info.name.equals("PaymentNoticeLegalDepartmentIndicator"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.PaymentNoticeLegalDepartmentIndicator = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.PaymentNoticeLegalDepartmentIndicator = (Boolean)obj;
                }
            }
            return true;
        }
        if (info.name.equals("PaymentNoticeAccountingIndicator"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.PaymentNoticeAccountingIndicator = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.PaymentNoticeAccountingIndicator = (Boolean)obj;
                }
            }
            return true;
        }
        if (info.name.equals("PaymentNoticeCustomerWithoutClearedItemsIndicator"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.PaymentNoticeCustomerWithoutClearedItemsIndicator = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.PaymentNoticeCustomerWithoutClearedItemsIndicator = (Boolean)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("BillOfExchangeChargesCashDiscountTermsCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.BillOfExchangeChargesCashDiscountTermsCode = (QBSCashDiscountTermsCode)__envelope.get(j,QBSCashDiscountTermsCode.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("ExportCreditInsuranceInstitutionID"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.ExportCreditInsuranceInstitutionID = (QBSIdentifier)__envelope.get(j,QBSIdentifier.class,false);
            }
            return true;
        }
        if (info.name.equals("InsuredAmount"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.InsuredAmount = (QBSAmount)__envelope.get(j,QBSAmount.class,false);
            }
            return true;
        }
        if (info.name.equals("InsuranceLeadDuration"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.InsuranceLeadDuration = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.InsuranceLeadDuration = (String)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("InsuranceID"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.InsuranceID = (QBSIdentifier)__envelope.get(j,QBSIdentifier.class,false);
            }
            return true;
        }
        if (info.name.equals("InsuranceValidityDate"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.InsuranceValidityDate = QBSHelper.ConvertFromWebService(j.toString());
                    }
                }
                else if (obj instanceof java.util.Date){
                    this.InsuranceValidityDate = (java.util.Date)obj;
                }
            }
            return true;
        }
        if (info.name.equals("CollectiveInvoiceVariantID"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.CollectiveInvoiceVariantID = (QBSIdentifier)__envelope.get(j,QBSIdentifier.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("NextPayeeInternalID"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.NextPayeeInternalID = j.toString();
                    }
                }
                else{
                    this.NextPayeeInternalID = obj.toString();
                }
            }
            return true;
        }
        if (info.name.equals("ReceiverNextPayeeInternalID"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.ReceiverNextPayeeInternalID = j.toString();
                    }
                }
                else{
                    this.ReceiverNextPayeeInternalID = obj.toString();
                }
            }
            return true;
        }
        ...
        if (info.name.equals("RecordPaymentHistoryIndicator"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.RecordPaymentHistoryIndicator = new Boolean(j.toString());
                    }
                }
                else if (obj instanceof Boolean){
                    this.RecordPaymentHistoryIndicator = (Boolean)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("PreviousCustomerInternalID"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.PreviousCustomerInternalID = j.toString();
                    }
                }
                else{
                    this.PreviousCustomerInternalID = obj.toString();
                }
            }
            return true;
        }
        ...
        if (info.name.equals("LeaveReasonCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.LeaveReasonCode = (QBSCode)__envelope.get(j,QBSCode.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("LockboxCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.LockboxCode = (QBSCode)__envelope.get(j,QBSCode.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("BuyingGroupInternalID"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.BuyingGroupInternalID = j.toString();
                    }
                }
                else{
                    this.BuyingGroupInternalID = obj.toString();
                }
            }
            return true;
        }
        if (info.name.equals("ReceiverBuyingGroupInternalID"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.ReceiverBuyingGroupInternalID = j.toString();
                    }
                }
                else{
                    this.ReceiverBuyingGroupInternalID = obj.toString();
                }
            }
            return true;
        }
        if (info.name.equals("PaymentAdvicesSelectionRuleCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.PaymentAdvicesSelectionRuleCode = (QBSCode)__envelope.get(j,QBSCode.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("ConversionVersionReasonCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.ConversionVersionReasonCode = (QBSCode)__envelope.get(j,QBSCode.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("ValueAdjustmentCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.ValueAdjustmentCode = (QBSCode)__envelope.get(j,QBSCode.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("AccountsReceivablePledgingCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.AccountsReceivablePledgingCode = (QBSCode)__envelope.get(j,QBSCode.class,false);
            }
            return true;
        }
        ...
        if (info.name.equals("WithholdingTax"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.WithholdingTax = new java.util.ArrayList< QBSBPSUITERplctReqCustWhldgTx>();
                }
                java.lang.Object j =obj;
                QBSBPSUITERplctReqCustWhldgTx j1= (QBSBPSUITERplctReqCustWhldgTx)__envelope.get(j,QBSBPSUITERplctReqCustWhldgTx.class,false);
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==12)
        {
            return this.PaymentNoticeCustomerClearedItemsIndicator!=null?this.PaymentNoticeCustomerClearedItemsIndicator:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==13)
        {
            return this.PaymentNoticeSalesDepartmentIndicator!=null?this.PaymentNoticeSalesDepartmentIndicator:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==14)
        {
            return this.PaymentNoticeLegalDepartmentIndicator!=null?this.PaymentNoticeLegalDepartmentIndicator:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==15)
        {
            return this.PaymentNoticeAccountingIndicator!=null?this.PaymentNoticeAccountingIndicator:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==16)
        {
            return this.PaymentNoticeCustomerWithoutClearedItemsIndicator!=null?this.PaymentNoticeCustomerWithoutClearedItemsIndicator:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==17)
        {
        ...
        if(propertyIndex==21)
        {
            return this.BillOfExchangeChargesCashDiscountTermsCode!=null?this.BillOfExchangeChargesCashDiscountTermsCode.getSimpleValue():null;
        }
        if(propertyIndex==22)
        {
        ...
        if(propertyIndex==29)
        {
            return this.ExportCreditInsuranceInstitutionID!=null?this.ExportCreditInsuranceInstitutionID.getSimpleValue():null;
        }
        if(propertyIndex==30)
        {
            return this.InsuredAmount!=null?this.InsuredAmount.getSimpleValue():null;
        }
        if(propertyIndex==31)
        {
            return this.InsuranceLeadDuration!=null?this.InsuranceLeadDuration:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==32)
        {
        ...
        if(propertyIndex==33)
        {
            return this.InsuranceID!=null?this.InsuranceID.getSimpleValue():null;
        }
        if(propertyIndex==34)
        {
            return this.InsuranceValidityDate!=null?QBSHelper.getDateFormat().format(this.InsuranceValidityDate):SoapPrimitive.NullSkip;
        }
        if(propertyIndex==35)
        {
            return this.CollectiveInvoiceVariantID!=null?this.CollectiveInvoiceVariantID.getSimpleValue():null;
        }
        if(propertyIndex==36)
        {
        ...
        if(propertyIndex==39)
        {
            return this.NextPayeeInternalID!=null?this.NextPayeeInternalID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==40)
        {
            return this.ReceiverNextPayeeInternalID!=null?this.ReceiverNextPayeeInternalID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==41)
        {
        ...
        if(propertyIndex==42)
        {
            return this.RecordPaymentHistoryIndicator!=null?this.RecordPaymentHistoryIndicator:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==43)
        {
        ...
        if(propertyIndex==48)
        {
            return this.PreviousCustomerInternalID!=null?this.PreviousCustomerInternalID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==49)
        {
        ...
        if(propertyIndex==50)
        {
            return this.LeaveReasonCode!=null?this.LeaveReasonCode.getSimpleValue():null;
        }
        if(propertyIndex==51)
        {
        ...
        if(propertyIndex==52)
        {
            return this.LockboxCode!=null?this.LockboxCode.getSimpleValue():null;
        }
        if(propertyIndex==53)
        {
        ...
        if(propertyIndex==54)
        {
            return this.BuyingGroupInternalID!=null?this.BuyingGroupInternalID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==55)
        {
            return this.ReceiverBuyingGroupInternalID!=null?this.ReceiverBuyingGroupInternalID:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==56)
        {
            return this.PaymentAdvicesSelectionRuleCode!=null?this.PaymentAdvicesSelectionRuleCode.getSimpleValue():null;
        }
        if(propertyIndex==57)
        {
        ...
        if(propertyIndex==59)
        {
            return this.ConversionVersionReasonCode!=null?this.ConversionVersionReasonCode.getSimpleValue():null;
        }
        if(propertyIndex==60)
        {
        ...
        if(propertyIndex==64)
        {
            return this.ValueAdjustmentCode!=null?this.ValueAdjustmentCode.getSimpleValue():null;
        }
        if(propertyIndex==65)
        {
        ...
        if(propertyIndex==66)
        {
            return this.AccountsReceivablePledgingCode!=null?this.AccountsReceivablePledgingCode.getSimpleValue():null;
        }
        if(propertyIndex>=67 && propertyIndex < 67+this.DunningInformation.size())
        {
            java.lang.Object DunningInformation = this.DunningInformation.get(propertyIndex-(67));
            return DunningInformation!=null?DunningInformation:SoapPrimitive.NullNilElement;
        }
        if(propertyIndex>=67+this.DunningInformation.size() && propertyIndex < 67+this.DunningInformation.size()+this.WithholdingTax.size())
        {
            java.lang.Object WithholdingTax = this.WithholdingTax.get(propertyIndex-(67+this.DunningInformation.size()));
            return WithholdingTax!=null?WithholdingTax:SoapPrimitive.NullNilElement;
        }
        if(propertyIndex>=67+this.DunningInformation.size()+this.WithholdingTax.size() && propertyIndex < 67+this.DunningInformation.size()+this.WithholdingTax.size()+this.AccountingText.size())
        {
            java.lang.Object AccountingText = this.AccountingText.get(propertyIndex-(67+this.DunningInformation.size()+this.WithholdingTax.size()));
    ...
    public int getPropertyCount() {
        return 67+DunningInformation.size()+WithholdingTax.size()+AccountingText.size();
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "PaymentNoticeCustomerClearedItemsIndicator";
            info.namespace= "";
        }
        if(propertyIndex==13)
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "PaymentNoticeSalesDepartmentIndicator";
            info.namespace= "";
        }
        if(propertyIndex==14)
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "PaymentNoticeLegalDepartmentIndicator";
            info.namespace= "";
        }
        if(propertyIndex==15)
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "PaymentNoticeAccountingIndicator";
            info.namespace= "";
        }
        if(propertyIndex==16)
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "PaymentNoticeCustomerWithoutClearedItemsIndicator";
            info.namespace= "";
        }
        if(propertyIndex==17)
        {
        ...
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "BillOfExchangeChargesCashDiscountTermsCode";
            info.namespace= "";
        }
        if(propertyIndex==22)
        {
        ...
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "ExportCreditInsuranceInstitutionID";
            info.namespace= "";
        }
        if(propertyIndex==30)
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "InsuredAmount";
            info.namespace= "";
        }
        if(propertyIndex==31)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "InsuranceLeadDuration";
            info.namespace= "";
        }
        if(propertyIndex==32)
        {
        ...
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "InsuranceID";
            info.namespace= "";
        }
        if(propertyIndex==34)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "InsuranceValidityDate";
            info.namespace= "";
        }
        if(propertyIndex==35)
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "CollectiveInvoiceVariantID";
            info.namespace= "";
        }
        if(propertyIndex==36)
        {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "NextPayeeInternalID";
            info.namespace= "";
        }
        if(propertyIndex==40)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "ReceiverNextPayeeInternalID";
            info.namespace= "";
        }
        if(propertyIndex==41)
        {
        ...
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "RecordPaymentHistoryIndicator";
            info.namespace= "";
        }
        if(propertyIndex==43)
        {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "PreviousCustomerInternalID";
            info.namespace= "";
        }
        if(propertyIndex==49)
        {
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "BuyingGroupInternalID";
            info.namespace= "";
        }
        if(propertyIndex==55)
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "ReceiverBuyingGroupInternalID";
            info.namespace= "";
        }
        if(propertyIndex==56)
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "PaymentAdvicesSelectionRuleCode";
            info.namespace= "";
        }
        if(propertyIndex==57)
        {
        ...
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "ConversionVersionReasonCode";
            info.namespace= "";
        }
        if(propertyIndex==60)
        {
        ...
        {
            info.type = org.ksoap2.serialization.SoapPrimitive.class;
            info.name = "AccountsReceivablePledgingCode";
            info.namespace= "";
        }
        if(propertyIndex>=67 && propertyIndex < 67+this.DunningInformation.size())
        {
        ...
        if(propertyIndex>=67+this.DunningInformation.size() && propertyIndex < 67+this.DunningInformation.size()+this.WithholdingTax.size())
        {
            info.type = QBSBPSUITERplctReqCustWhldgTx.class;
