...
public class QBSBPSUITERplctReqAddrInfoAddrEml extends AttributeContainer implements KvmSerializable
{
    ...
    public ArrayList< QBSBPSUITERplctReqNote> EmailNote =new ArrayList<QBSBPSUITERplctReqNote >();
    
    public ArrayList< QBSBPSUITERplctReqAddrInfoAddrEmlUsge> EmailUsage =new ArrayList<QBSBPSUITERplctReqAddrInfoAddrEmlUsge >();
    
    public String actionCode;
    
    public Boolean eMailNoteListCompleteTransmissionIndicator=false;
    ...
    public void loadFromSoap(java.lang.Object paramObj,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (inObj.hasAttribute("eMailNoteListCompleteTransmissionIndicator"))
        {	
            java.lang.Object j = inObj.getAttribute("eMailNoteListCompleteTransmissionIndicator");
            if (j != null)
            {
                eMailNoteListCompleteTransmissionIndicator = new Boolean(j.toString());
            }
        }
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("EmailNote"))
        {
            if(obj!=null)
            {
                if(this.EmailNote==null)
                {
                    this.EmailNote = new java.util.ArrayList< QBSBPSUITERplctReqNote>();
                }
                java.lang.Object j =obj;
                QBSBPSUITERplctReqNote j1= (QBSBPSUITERplctReqNote)__envelope.get(j,QBSBPSUITERplctReqNote.class,false);
                this.EmailNote.add(j1);
            }
            return true;
        }
        if (info.name.equals("EmailUsage"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.EmailUsage = new java.util.ArrayList< QBSBPSUITERplctReqAddrInfoAddrEmlUsge>();
                }
                java.lang.Object j =obj;
                QBSBPSUITERplctReqAddrInfoAddrEmlUsge j1= (QBSBPSUITERplctReqAddrInfoAddrEmlUsge)__envelope.get(j,QBSBPSUITERplctReqAddrInfoAddrEmlUsge.class,false);
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=4 && propertyIndex < 4+this.EmailNote.size())
        {
            java.lang.Object EmailNote = this.EmailNote.get(propertyIndex-(4));
            return EmailNote!=null?EmailNote:SoapPrimitive.NullNilElement;
        }
        if(propertyIndex>=4+this.EmailNote.size() && propertyIndex < 4+this.EmailNote.size()+this.EmailUsage.size())
        {
            java.lang.Object EmailUsage = this.EmailUsage.get(propertyIndex-(4+this.EmailNote.size()));
    ...
    public int getPropertyCount() {
        return 4+EmailNote.size()+EmailUsage.size();
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex>=4+this.EmailNote.size() && propertyIndex < 4+this.EmailNote.size()+this.EmailUsage.size())
        {
            info.type = QBSBPSUITERplctReqAddrInfoAddrEmlUsge.class;
    ...
    public void getAttributeInfo(int index, AttributeInfo info) {
        ...
        if(index==1)
        {
            info.name = "eMailNoteListCompleteTransmissionIndicator";
            info.namespace= "";
            if(this.eMailNoteListCompleteTransmissionIndicator!=null)
            {
                info.setValue(this.eMailNoteListCompleteTransmissionIndicator);
            }
