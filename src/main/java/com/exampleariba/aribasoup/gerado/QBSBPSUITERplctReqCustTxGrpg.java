...
public class QBSBPSUITERplctReqCustTxGrpg extends AttributeContainer implements KvmSerializable
{
    ...
    public QBSBPSUITERplctReqTxExmp TaxExemption;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("TaxExemption"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.TaxExemption = (QBSBPSUITERplctReqTxExmp)__envelope.get(j,QBSBPSUITERplctReqTxExmp.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.TaxExemption!=null?this.TaxExemption:SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = QBSBPSUITERplctReqTxExmp.class;
            info.name = "TaxExemption";
            info.namespace= "";
        }
    }
