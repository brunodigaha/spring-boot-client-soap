...
public class QBSBPSUITERplctReqProcmtCardIssuingInstitutes extends AttributeContainer implements KvmSerializable
{

    
    public QBSPartyInternalID PaymentCardIssuerPartyInternalID;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("PaymentCardIssuerPartyInternalID"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.PaymentCardIssuerPartyInternalID = (QBSPartyInternalID)__envelope.get(j,QBSPartyInternalID.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.PaymentCardIssuerPartyInternalID!=null?this.PaymentCardIssuerPartyInternalID.getSimpleValue():null;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex==0)
        {
            ...
            info.name = "PaymentCardIssuerPartyInternalID";
            info.namespace= "";
        }
    }
