...
public class QBSBPRelshpSUITERplctReqMsg extends AttributeContainer implements KvmSerializable
{

    
    public QBSBusinessDocumentMessageHeader MessageHeader;
    
    public QBSBPRelshpSUITERplctReqBPRelshp BusinessPartnerRelationship;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("BusinessPartnerRelationship"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.BusinessPartnerRelationship = (QBSBPRelshpSUITERplctReqBPRelshp)__envelope.get(j,QBSBPRelshpSUITERplctReqBPRelshp.class,false);
            }
            return true;
        }
        return false;
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==1)
        {
            info.type = QBSBPRelshpSUITERplctReqBPRelshp.class;
