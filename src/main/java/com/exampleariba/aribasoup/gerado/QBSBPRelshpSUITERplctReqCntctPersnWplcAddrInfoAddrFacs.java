...
public class QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacs extends AttributeContainer implements KvmSerializable
{
    ...
    public ArrayList< QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacsUsge> FacsimileUsage =new ArrayList<QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacsUsge >();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("FacsimileUsage"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.FacsimileUsage = new java.util.ArrayList< QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacsUsge>();
                }
                java.lang.Object j =obj;
                QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacsUsge j1= (QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacsUsge)__envelope.get(j,QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacsUsge.class,false);
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=4 && propertyIndex < 4+this.FacsimileUsage.size())
        {
            java.lang.Object FacsimileUsage = this.FacsimileUsage.get(propertyIndex-(4));
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex>=4 && propertyIndex < 4+this.FacsimileUsage.size())
        {
            info.type = QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrFacsUsge.class;
