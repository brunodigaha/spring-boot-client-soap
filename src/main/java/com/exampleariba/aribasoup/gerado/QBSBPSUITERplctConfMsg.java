...
public class QBSBPSUITERplctConfMsg extends AttributeContainer implements KvmSerializable
{

    
    public QBSBusinessDocumentMessageHeader MessageHeader;
    
    public QBSBPSUITERplctConfBP BusinessPartner;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("BusinessPartner"))
        {
            ...
            {
                java.lang.Object j = obj;
                this.BusinessPartner = (QBSBPSUITERplctConfBP)__envelope.get(j,QBSBPSUITERplctConfBP.class,false);
            }
            return true;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==1)
        {
            info.type = QBSBPSUITERplctConfBP.class;
