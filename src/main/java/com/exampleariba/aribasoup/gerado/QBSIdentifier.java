...
public class QBSIdentifier  
{
    ...
    public void loadFromSoap(java.lang.Object paramObj,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (inObj.hasAttribute("schemeVersionID"))
        {	
            java.lang.Object j = inObj.getAttribute("schemeVersionID");
            if (j != null)
            {
                schemeVersionID = j.toString();
            }
        }
    ...
    public Object getSimpleValue()
    {
        ...
        if (this.schemeVersionID != null)
        {
            AttributeInfo attrInfo = new AttributeInfo();
            attrInfo.setName("schemeVersionID");
            attrInfo.setValue(this.schemeVersionID);
            attrInfo.setNamespace("");
            primitive.addAttribute(attrInfo);
        }
