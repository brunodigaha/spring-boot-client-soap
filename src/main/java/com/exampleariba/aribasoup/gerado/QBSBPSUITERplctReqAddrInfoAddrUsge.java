...
public class QBSBPSUITERplctReqAddrInfoAddrUsge extends AttributeContainer implements KvmSerializable
{

    
    public QBSAddressUsageCode AddressUsageCode;
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("AddressUsageCode"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.AddressUsageCode = (QBSAddressUsageCode)__envelope.get(j,QBSAddressUsageCode.class,false);
            }
            return true;
        }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.AddressUsageCode!=null?this.AddressUsageCode.getSimpleValue():null;
        }
        if(propertyIndex==1)
        {
