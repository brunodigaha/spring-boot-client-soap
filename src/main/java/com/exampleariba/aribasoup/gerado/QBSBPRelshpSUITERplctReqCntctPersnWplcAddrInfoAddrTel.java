...
public class QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTel extends AttributeContainer implements KvmSerializable
{
    ...
    public ArrayList< QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTelUsge> TelephoneUsage =new ArrayList<QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTelUsge >();
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("TelephoneUsage"))
        {
            if(obj!=null)
            {
                ...
                {
                    this.TelephoneUsage = new java.util.ArrayList< QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTelUsge>();
                }
                java.lang.Object j =obj;
                QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTelUsge j1= (QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTelUsge)__envelope.get(j,QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTelUsge.class,false);
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=6 && propertyIndex < 6+this.TelephoneUsage.size())
        {
            java.lang.Object TelephoneUsage = this.TelephoneUsage.get(propertyIndex-(6));
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex>=6 && propertyIndex < 6+this.TelephoneUsage.size())
        {
            info.type = QBSBPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrTelUsge.class;
