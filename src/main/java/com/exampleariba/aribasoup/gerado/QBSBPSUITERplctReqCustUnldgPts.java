...
public class QBSBPSUITERplctReqCustUnldgPts extends AttributeContainer implements KvmSerializable
{
    ...
    public QBSBPSUITERplctReqBusHrs BusinessHours;
    
    public Boolean actionCode=false;
    ...
    public void loadFromSoap(java.lang.Object paramObj,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        {	
            ...
            if (j != null)
            {
                actionCode = new Boolean(j.toString());
            }
        }
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,QBSExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("UnloadingPointName"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.UnloadingPointName = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.UnloadingPointName = (String)obj;
                }
            }
            return true;
        }
        ...
        if (info.name.equals("BusinessHours"))
        {
            if(obj!=null)
            {
                java.lang.Object j = obj;
                this.BusinessHours = (QBSBPSUITERplctReqBusHrs)__envelope.get(j,QBSBPSUITERplctReqBusHrs.class,false);
            }
            return true;
        }
        return false;
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.BusinessHours!=null?this.BusinessHours:SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = QBSBPSUITERplctReqBusHrs.class;
            info.name = "BusinessHours";
            info.namespace= "";
        }
    }
