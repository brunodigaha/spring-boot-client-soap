...
/**
 * <p>Classe Java de BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEml complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEml"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="EmailUsage" type="{http://ariba.com/xi/SupplierManagement}BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEmlUsge" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEml", propOrder = {
    "uri",
...
public class BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEml {
    ...
    protected List<BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEmlUsge> emailUsage;
     ...
     * {@link BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEmlUsge }
     * 
     * 
     */
    public List<BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEmlUsge> getEmailUsage() {
        if (emailUsage == null) {
            emailUsage = new ArrayList<BPRelshpSUITERplctReqCntctPersnWplcAddrInfoAddrEmlUsge>();
        }
